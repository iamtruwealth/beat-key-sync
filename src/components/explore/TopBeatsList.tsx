              ...
              <Card key={beat.id} className="hover:bg-muted/30 transition-colors">
                <CardContent className="p-4">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    {/* Mobile: Top Row with Rank, Play, and Basic Info */}
                    <div className="flex items-center gap-4 w-full sm:flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {/* Mobile: Show beat details on second line */}
                        <div className="flex items-center gap-2 text-xs text-muted-foreground mt-1 sm:hidden">
                          ...
                          {beat.genre && <Badge variant="secondary" className="text-xs">{beat.genre}</Badge>}
                        </div>
                      </div>
                    </div>

                    {/* Desktop: Beat Details */}
                  ...
                  {beat.tags && beat.tags.length > 0 && (
                    <div className="flex flex-wrap gap-1 mt-3 pl-4 sm:pl-20">
