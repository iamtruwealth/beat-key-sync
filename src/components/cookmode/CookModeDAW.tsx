  ...
  return (
    ...
    >
      ...
      >
        {/* Drag overlay */}
        {isDragOver && (
          <div className="absolute inset-0 z-10 bg-background/80 backdrop-blur-sm border-2 border-dashed border-neon-cyan flex items-center justify-center pointer-events-none">
