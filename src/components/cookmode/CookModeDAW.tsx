    ...
    <div className="h-full flex flex-col bg-background/50">
      ...
      <div className="p-4 border-b border-border/50 bg-card/20 backdrop-blur-sm">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold text-foreground">DAW Timeline</h3>
        ...
        {tracks.length === 0 ? (
          <div className="h-full flex items-center justify-center">
            <div className="text-center p-8">
              ...
              <h4 className="text-lg font-medium text-foreground mb-2">No tracks yet</h4>
              <p className="text-muted-foreground mb-4">Add your first track to start cooking</p>
