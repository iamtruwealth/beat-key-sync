...
CREATE TABLE public.notifications (
  ...
  type TEXT NOT NULL CHECK (type IN ('follow', 'like', 'comment', 'beat', 'beat_pack', 'post')),
  item_id UUID,
...
BEGIN
  INSERT INTO public.notifications (user_id, type, message, item_id, actor_id)
  VALUES (target_user_id, notification_type, notification_message, notification_item_id, notification_actor_id)
